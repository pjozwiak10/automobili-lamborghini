...
const MurcielagoModel = memo(({ canvasContainerRef, carChanges }) => {
  ...
  useEffect(() => {
    ...
    loader.load(murcielagoModel, (gltf) => {
      ...
      theModel.current.rotation.y = Math.PI / 6;
      theModel.current.rotation.z = Math.PI / 36;
      theModel.current.position.y = -1.2;
    ...
    scene.add(dirLight2);
    const dirLight3 = new THREE.DirectionalLight(0xffffff, 13);
